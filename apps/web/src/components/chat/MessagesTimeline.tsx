  ...
  return (
    <div className="group flex flex-col items-end gap-1">
      <div className="relative max-w-[80%] rounded-2xl bg-accent p-3">
        <MessageImageAttachmentGrid images={regularImages} className="mb-2 max-w-[420px]" />
...
function MessageImageAttachmentGrid({
  images,
  className,
}: {
  ...
  return (
    <>
      <div className="relative min-w-0 px-1 py-0.5">
        <MessageImageAttachmentGrid images={assistantImages} className="mb-2 max-w-[640px]" />
        {messageText ? (
          <ChatMarkdown
            text={messageText}
            cwd={ctx.markdownCwd}
