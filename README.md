...
> - Pi: install the Pi CLI and configure a provider API key (Pi is Early Access and disabled by default — see [the Pi provider guide](./docs/user/pi.md))
